...
function doImage(word) {
    ...
    gm(thisPath + 'img/' + wmCount + 'wm_social.jpg').gravity('Center').fill('#FFFFFF').font(thisPath + "fnt/RobotoCondensed-Bold.ttf", wmSize).drawText(0, 0, word).write(thisPath + imgDest, function(err) {
